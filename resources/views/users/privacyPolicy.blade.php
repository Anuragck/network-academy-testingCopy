...
<p class="text-justify">
    ...
    <p class="text-justify">
    We may invite you to complete a survey or participate in a promotion (contest , challenges, quiz  ) either through the services or third party platform . if you participate  we will collect and store the data you provide as part of participating such as your name , email address date of birth , phone number. The data collected will be used to administer the promotion or survey, including for notifying winners and distributing prize. To receive a reward, you may be required to allow us to post some of your information publicly.

    Our Website links to other websites that may collect personally identifiable information about you. <strong>Network Academy</strong>  is not responsible for the privacy practices or the content of those linked websites.
</p>
                </div>
